...
import { SummonSkill } from '../domain/AttackAction/Skill/SummonSkill/SummonSkill'
...
function createSummonBattle(): RPG {
...
describe('summon testcase', () => {
  ...
  it('should match the expected battle output', async () => {
    const actions = readHeroActions('summon')
    const expectedOutput = readExpectedOutput('summon')
